...
- [ ] Made at least 1 meaningful commit with a commit message that includes the last word from each of these documentation files: `docs/introduction.md`, `docs/accounts.md`, `docs/prerequisites.md`, and `docs/submission-guide.md`. Edit any file (even adding a new line or space works) and use all four last words naturally in your commit message. This proves you've read the essential documentation.
